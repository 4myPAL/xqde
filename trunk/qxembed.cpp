...
//TODO:static QPtrDict<QGuardedPtr<QWidget> > *focusMap = 0;
...
{
//qWarning("QXEmbedAppFilter::eventFilter(%d,%d)",(int)o,e->type());
return false;
...
{
static Atom qt_wm_protocols=XInternAtom( qt_xdisplay(), "WM_PROTOCOLS", False );
static Atom qt_wm_take_focus=XInternAtom( qt_xdisplay(), "WM_TAKE_FOCUS", False );
...
//TODO:            if ( msgtime > qt_x_time )
//TODO:                qt_x_time = msgtime;
...
//TODO:                QTLWExtra *extra = ((QPublicWidget*)w->topLevelWidget())->topData();
//TODO:extra->embedded = 1;
//TODO:                extra->parentWinId = e->xclient.data.l[3];
...
/*TODO:                    QGuardedPtr<QWidget>* fw = focusMap->find( w->topLevelWidget() );
                    if ( fw ) {
                        focusCurrent = *fw;
...
//TODO                        qt_x_time = e->xclient.data.l[1];
...
//TODO:    oldFilter = qt_set_x11_event_filter( qxembed_x11_event_filter );
...
QXEmbed::QXEmbed(QWidget *parent, const char *name, Qt::WindowFlags f)
...
Atom qt_wm_state=XInternAtom( qt_xdisplay(), "WM_STATE", False );
...
{
//qWarning("QXEmbed::x11Event(%d,%d)",(int)window,(int)e->type);
    switch ( e->type ) {
    case DestroyNotify:
...
//TODO:            extraData()->xDndProxy = window;
            if ( parent() ) {
...
//    QWhatsThis::leaveWhatsThisMode();
    if ( !context_help )
        context_help = XInternAtom( qt_xdisplay(), "_NET_WM_CONTEXT_HELP", false );
...
void QXEmbed::reparent( QWidget * parent, Qt::WindowFlags f, const QPoint & p, bool showIt )
{
