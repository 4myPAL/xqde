...
////
////		x->setImage(":images/xqde_logo.png",XQImage_Normal);
////		x->setImage(":images/bttxt.png",XQImage_Clicked);
////
////		x->show();
////	}
//
...
////		x->setImage(":images/xqde_logo.png");
...
void XQDEBase::mouseMoveEvent(QMouseEvent *ev)
{
    qDebug("ciaoo");
    for (int i = 0; i < globalXQImages.size(); ++i)
    {
	    globalXQImages.at(i)->MoveEvent(ev);
    }
}
