...
Imported_KDETrayProxy::Imported_KDETrayProxy()
...
Atom Imported_KDETrayProxy::makeSelectionAtom()
    {
...
void Imported_KDETrayProxy::windowAdded( WId w )
    {
...
void Imported_KDETrayProxy::newOwner( Window owner )
    {
...
bool Imported_KDETrayProxy::x11Event( XEvent* e )
    {
...
void Imported_KDETrayProxy::dockWindow( Window w, Window owner )
    {
...
void Imported_KDETrayProxy::withdrawWindow( Window w )
    {
