...
QStringList XQDEPlugin_AnalogClock::effects() const
{
    return QStringList() << "AnalogClock";
}
...
////	if(lastValue!=Value)
////	{
////		xSetTitle(QDateTime::currentDateTime().toString("dddd d MMMM yyyy hh:mm"));
////
...
Q_EXPORT_PLUGIN2(analogclock, XQDEPlugin_AnalogClock)
