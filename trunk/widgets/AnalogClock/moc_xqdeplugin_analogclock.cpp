...
**
** Created: Sat Apr 24 23:21:48 2010
...
static const char qt_meta_stringdata_XQDEPlugin_AnalogClock[] = {
    "XQDEPlugin_AnalogClock\0"
};

const QMetaObject XQDEPlugin_AnalogClock::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_XQDEPlugin_AnalogClock,
...
void *XQDEPlugin_AnalogClock::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "XQDEWidgetInterface"))
        return static_cast< XQDEWidgetInterface*>(const_cast< XQDEPlugin_AnalogClock*>(this));
    if (!strcmp(_clname, "com.XQDE.Plugin.XQDEWidgetInterface/1.0"))
        return static_cast< XQDEWidgetInterface*>(const_cast< XQDEPlugin_AnalogClock*>(this));
